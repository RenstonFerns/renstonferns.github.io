...
1. [Why I Started This Blog](#why-i-started-this-blog)
2. [What Are Circular Carbon E-Fuels?](#what-are-circular-carbon-e-fuels)
3. [Why Liquid Fuels Still Matter](#why-liquid-fuels-still-matter)
4. [The Carbon Question](#the-carbon-question)
5. [Beyond Yield: LCA, TEA, and Combustion](#beyond-yield)
6. [What to Expect from My Blog](#what-to-expect)
...
## What Are Circular Carbon E-Fuels? {#what-are-circular-carbon-e-fuels}
...
## Why Liquid Fuels Still Matter {#why-liquid-fuels-still-matter}
...
## The Carbon Question {#the-carbon-question}
...
* carbon in the main biomass feedstock,
* carbon in agricultural residues,
* CO₂ released during fermentation,
* CO₂ generated during gasification or upgrading,
* carbon contained in liquid fuel products.
...
## Beyond Yield: LCA, TEA, and Combustion {#beyond-yield}
...
* What are the mass and energy flows?
* How much CO₂ is captured or utilized?
* What are the major energy demands?
...
### 4. Combustion and end-use performance
...
## What to Expect from My Blog {#what-to-expect}
...
* circular carbon e-fuels and CO₂-to-X systems,
* biomass-to-methanol and e-methanol pathways,
* life cycle assessment for emerging fuel technologies,
* techno-economic analysis and cost drivers,
* process modelling using Aspen Plus,
* uncertainty analysis and scenario matrices,
* clean combustion and alcohol fuel blends,
* conference reflections and research travel,
* academic writing, presentations, and scientific communication.
...
* International Energy Agency reports on low-carbon fuels and hydrogen
* GREET model resources for fuel pathway assessment
